...
namespace DneTrainNg.models.IdentityMigrations
{
    ...
    [Migration("20180131082758_removeColLength")]
    partial class removeColLength
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DneTrainNg.Models.ApplicationRole", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("DneTrainNg.Models.ApplicationRole")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("DneTrainNg.Models.ApplicationUser")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
